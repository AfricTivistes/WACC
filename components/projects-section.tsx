  ...
  const projects = [
    {
      ...
      description:
        "Cours en ligne sur la démocratie, les élections et la gouvernance pour les citoyens et activistes africains.",
    ...
    },
    {
      ...
      title: "Citizen Lab",
      description:
        "Formation et outils pour la société civile, incubant des solutions civic tech initiées par les citoyens.",
    ...
    },
    {
      ...
      title: "Taxaw Temm",
      description:
        "Programme de formation en cybersécurité pour les femmes, visant à combattre les violences en ligne et renforcer la résilience numérique.",
    ...
    <section id="projects" className="py-16 md:py-24">
      <div className="container">
        <AnimatedElement animation="fade-up" className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 gradient-text">Nos Projets</h2>
          <p className="text-gray-600 dark:text-gray-400">
            Découvrez nos initiatives innovantes qui utilisent la technologie pour renforcer la démocratie, la
            transparence et l'engagement citoyen en Afrique.
          </p>
        </AnimatedElement>
